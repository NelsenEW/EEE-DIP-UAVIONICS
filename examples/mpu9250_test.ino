...
*/
const uint8_t Gscale = GFS_250DPS, Ascale = AFS_2G, Mscale = MFS_16BITS, Mmode = M_100Hz, sampleRate = 0x04;
...
float   gyroBias[3] = { -1.54, -2.37, 0.53}, accelBias[3] = {13.73, -18.98, -4.52};
float   magBias[3] = {287.88, -46.48, -430.32}, magScale[3]  = {1.62, 1.32, 1.4}; // Bias corrections for gyro and accelerometer
