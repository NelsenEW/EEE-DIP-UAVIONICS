 ...
 * @version Feb 2020
 * 
 * Demonstrate basic MPU-6050 functionality including parameterizing the register addresses, initializing the sensor, 
 * getting properly scaled accelerometer, and gyroscope data out. 
 * Addition of 6 DoF sensor fusion using open source Madgwick filter algorithm by Sebastian Madgwick. 
*/
...
void MPU6050lib::initMPU6050()
{
  ...
  // Set interrupt pin active low, push-pull, and clear on any read
  // can join the I2C bus and all can be controlled by the Arduino as master
  writeByte(MPU6050_ADDRESS, INT_PIN_CFG, 0xB0);
